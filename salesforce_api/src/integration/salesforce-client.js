...
const { SALESFORCE_URL, AURA_TOKEN, AURA_CONTEXT, COOKIE, X_SFDC_Page_Scope_Id, REPORT_ID, ALLOWED_CASE_TYPES_RAW } = require('../config/env');
const { formatToTalabatEmail } = require('../utils/formatters');
...
class SalesforceClient {
    ...
    async fetchOpenCasesReport(retries = 3) {
